				...
				<section id="posts">
					...
					<section id="single">
						<header>
							...
							<h2>The Last of Us , Naught Dog, acertou mais uma vez!</h2>
							<div id="postMeta">
								<ul>
						...
						<article>
							<p>The Last of Us é um jogo eletrónico na terceira pessoa de aventura/acção com elementos de sobrevivência e de horror. Foi desenvolvido pela Naughty Dog e lançado mundialmente no dia 14 de Junho de 2013 para a PlayStation 3.</p>
							<br/>
							<p>O jogador controla Joel, a percorrer os Estados Unidos num ambiente pós-apocalíptico em 2033 e que tem como missão escoltar a jovem Ellie até um grupo de resistentes amigáveis, os Fireflies. O jogador tem de se defender contra criaturas do género zombies infectadas com o fungo cordyceps, bem como bandidos e canibais humanos hostis, usando armas de fogo e métodos de infiltração melhoradas com capacidades como representações visuais de som para conseguir ouvir as localizações dos inimigos. O jogador também pode fabricar armas e recursos médicos combinando itens encontrados pelo mundo.</p>
							<br/>
							<p>Aquando do lançamento, The Last of Us recebeu aclamação universal. Actualmente detém uma pontuação de 95/100 no Metacritic e de 94.58% no GameRankings. Recebeu pontuações perfeitas de várias publicações. Os criticos elogiaram vários dos aspectos do jogo, incluindo a jogabilidade baseada em escolhas, acção realista, profundidade emocional e som. Várias publicações declararam o jogo como uma obra-prima,8 9 e um dos títulos mais significativos para a sétima geração de consolas. The Last of Us recebeu diversos prémios "Melhor Jogo" e "Jogo do Ano" de várias publicações incluindo Game Informer, IGN, Destructoid, Kotaku, GameTrailers, Cheat Code Central e nos BAFTA Awards 2014, tornando-se no jogo mais premiado de sempre pelos críticos. The Last of Us foi o segundo maior lançamento de videojogos de 2013 (depois de Grand Theft Auto V), vendendo 1.3 milhões de cópias na primeira semana.</p>
						</article>
						<footer>
