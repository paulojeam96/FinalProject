			...
			<section id="contentBody">
				<section id="posts">
					...
					<section id="single">
						<header>
							<figure><img src="images/watchdogs.jpg" alt="img" /></figure>
							<h2>Watch Dogs - Exclusivo de PS4 </h2>
							<div id="postMeta">
								<ul>
