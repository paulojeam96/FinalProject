				...
				<section id="posts">
					...
					<section id="single">
						<header>
							...
							<h2>Guild Wars 2 - MMORPG renomado</h2>
							<div id="postMeta">
								<ul>
						...
						<article>
							<p>A NCSoft, criadora de Guild Wars 2, tem muito a comemorar. De acordo com dados fornecidos pela empresa de pesquisa DFC, o game foi o MMORPG que vendeu mais rápido no ocidente até hoje, atingindo a marca de três milhões de cópias nos primeiros nove meses desde o seu lançamento. </p>
							<br/>
							<p>David Cole, da DFC, declarou: "Depois da triangulação de múltiplas fontes de dados, fica claro que Guild Wars 2 é o MMO ocidental mais vendido de todos os tempos com base nos nove primeiros meses de disponibilidade. Isso coloca Guild Wars 2 em uma posição impressionante quando eles o lançarem na China, onde vimos franquias semelhantes realmente decolar". </p>
							<br/>
							<p>Se você é um fã de MMO e ainda não jogou Guild Wars 2, fique ligado: A ArenaNet vai disponibilizar um período gratuito de testes que vai do dia 23 ao dia 26 de agosto para todos aqueles que quiserem conhecer o jogo. </p>
							<br/>
							<p>Para comemorar o aniversário de um ano do jogo, os fãs da série confeccionaram e publicaram no NeoGAF um infográfico que apresenta uma série de dados importantes sobre o game: </p>
						</article>
						<footer>
